...
def get_cam2rgb_matrix(raw):
    ...
    # rgb2xyz_var = np.array([
    #     # [np.random.uniform(-0.1, 0.1), np.random.uniform(-0.05, 0.05), np.random.uniform(-0.05, 0.05)],
    #     [0, 0, 0],
    #     [np.random.uniform(-0.05, 0.05), np.random.uniform(-0.1, 0.1), np.random.uniform(-0.05, 0.05)],
    #     [np.random.uniform(-0.01, 0.05), np.random.uniform(-0.05, 0.05), np.random.uniform(-0.1, 0.1)],
    # ])
    # rgb2xyz_var[0] = - (rgb2xyz_var[1] + rgb2xyz_var[12])
    # rgb2xyz = rgb2xyz + rgb2xyz_var
